...
st.header("We provide the Greatest platform for you to collect all inf")
st.image("app.png")
...
st.markdown("#### :two: Stock Predicition")
st.write("You can explore predicted closing prices for the next 30 days based  on historical stock data an advanced ")
